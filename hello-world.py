...
while True:
    ...
    time.sleep(1)
    angle = servo5.get_commanded_angle() 
    print('M5:',val, angle)
    ...
    time.sleep(1)
    angle = servo1.get_commanded_angle() 
    print('M1:',val, angle)
